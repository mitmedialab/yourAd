var picinjection = {
    ...
    _getPlacementFor: function(el, callback) {
        ...
        BGcall("randomListing", {width:t.x, height:t.y}, function(pic) {
            ...
            result.url = pic.url;
            result.click_url = pic.click_url;
            result.ad_name = pic.ad_name;
            result.ad_success = pic.ad_success;
            result.ad_campaign = pic.ad_campaign;
    ...
    _augment: function(el, callback) {
        ...
        this.enabled(function(enabled) {
            ...
            that._getPlacementFor(el, function(placement) {
                ...
                newPic.addEventListener("click", function(e) {
                    BGcall("clickAd", {name:placement.ad_name, success:placement.ad_success, campaign:placement.ad_campaign});
                });

                var piclink = document.createElement("a");
                console.log(placement);
                piclink.setAttribute('href', placement.click_url);

                piclink.appendChild(newPic);
                el.dataset.picinjectionaugmented = "true";
                el.parentNode.insertBefore(piclink, el);
    ...
    _forceToOriginalSizeAndAugment: function(el, displayValue) {
        ...
        console.log('Found and replacing a blocked ad element:');
        console.log(el);
